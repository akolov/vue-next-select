import { ref, onMounted, onUpdated, openBlock, createBlock, renderSlot, createVNode, withKeys, withModifiers, inject, mergeProps, Fragment, renderList, toDisplayString, createCommentVNode, reactive, toRef, computed, watchEffect, getCurrentInstance, watch, nextTick, provide, resolveComponent, withCtx, withDirectives, vShow } from 'vue';
...
function render$3(_ctx, _cache, $props, $setup, $data, $options) {
  return openBlock(), createBlock("div", _hoisted_1$1, [renderSlot(_ctx.$slots, "prepend"), createVNode("input", {
    ...
    onKeyup: _cache[5] || (_cache[5] = withKeys(withModifiers(function () {
  ...
  , ["autocomplete", "modelValue", "placeholder", "disabled", "tabindex", "autofocus", "aria-controls", "aria-labelledby"]), renderSlot(_ctx.$slots, "append")]);
}
...
function render$2(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  }, $setup.dataAttrs), [(openBlock(true), createBlock(Fragment, null, renderList($props.modelValue, function (option) {
    return openBlock(), createBlock(Fragment, {
      key: option.key
    }, [!option.group ? (openBlock(), createBlock("li", {
      key: 0,
      "class": ["vue-tag", {
...
function render$1(_ctx, _cache, $props, $setup, $data, $options) {
  return openBlock(), createBlock("ul", mergeProps({
  ...
  }), [(openBlock(true), createBlock(Fragment, null, renderList($props.modelValue, function (option, index) {
    return openBlock(), createBlock(Fragment, {
      key: option.key
    }, [option.visible && option.hidden === false ? (openBlock(), createBlock("li", {
      key: 0,
    ...
    , ["onClick", "onMouseenter", "id", "aria-selected", "aria-disabled"])) : createCommentVNode("v-if", true)], 64
    /* STABLE_FRAGMENT */
    );
  }), 128
  /* KEYED_FRAGMENT */
...
var _hoisted_3 = /*#__PURE__*/createVNode("span", {
  "class": "icon loading"
}, [/*#__PURE__*/createVNode("div"), /*#__PURE__*/createVNode("div"), /*#__PURE__*/createVNode("div")], -1
/* HOISTED */
);
...
var _hoisted_5 = /*#__PURE__*/createVNode("span", {
  "class": "icon loading"
}, [/*#__PURE__*/createVNode("div"), /*#__PURE__*/createVNode("div"), /*#__PURE__*/createVNode("div")], -1
/* HOISTED */
);
...
function render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return openBlock(), createBlock("div", mergeProps({
    ...
    onKeypress: _cache[12] || (_cache[12] = withKeys(withModifiers(function () {
    ...
    }, ["prevent", "exact"]), ["down"])), _cache[14] || (_cache[14] = withKeys(withModifiers(function () {
      return _ctx.pointerBackward && _ctx.pointerBackward.apply(_ctx, arguments);
    }, ["prevent", "exact"]), ["up"])), _cache[15] || (_cache[15] = withKeys(withModifiers(function () {
      return _ctx.pointerFirst && _ctx.pointerFirst.apply(_ctx, arguments);
    }, ["prevent", "exact"]), ["home"])), _cache[16] || (_cache[16] = withKeys(withModifiers(function () {
  ...
  /* NEED_PATCH */
  ), _ctx.multiple && _ctx.taggable && _ctx.searchable ? (openBlock(), createBlock("div", _hoisted_4, [withDirectives(createVNode(_component_v_input, {
    ref: "input",
    modelValue: _ctx.searchingInputValue,
